...
Here's an example screenshot of the **Scatter Plot** section of the app. You choose the variables with the dropdown menus. There can be extra choices to make. In this case, whether to use a smaller sample and display a smoother as seen in [2.2.3.2 Pairwise plot matrix](@sec-pairwise-plot-matrix).

![Figure 2.1: A similar scatter plot to the one we created with DataExplorer in [2.2.2.3 Numerical Columns](@sec-numerical-columns)](img/figure-2-1.png){.lightbox}
...
![Figure 2.2: Another similar scatter plot to the one we created with DataExplorer in [2.2.2.3 Numerical Columns](@sec-numerical-columns)](img/figure-2-2.png){.lightbox}
...
![Figure 2.4: Yet another similar scatter plot to the one we created with DataExplorer in [2.2.2.3 Numerical Columns](@sec-numerical-columns)](img/figure-2-4.png){.lightbox}
