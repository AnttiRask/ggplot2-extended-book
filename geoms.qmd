...
If you’ve read the book in chronological order, you’ve already encountered a streamgraph in @sec-landscape. We will use that visualization as the example in this chapter.
...
Let’s first take a look at what the streamgraph would look like with default settings.
...
The labels are in an HTML-style format. We’ll delve into this topic in more detail in @sec-ggtext.
