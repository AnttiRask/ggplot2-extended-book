...
In this section, I'll introduce you to __ggforce__ [@pedersen2025b]. It's a package that, among other things, lets you draw a variety of geometric primitives. We can file them under two main categories: __lines__ and __shapes__.
...
Before moving on from geometric shapes, there is a new-ish package, __ggdiagram__ [@schneider2025]. It provides an alternate way to produce many of them.
