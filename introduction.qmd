...
Hi! I’m Antti Rask, a data specialist if you had to choose one label. I’ve lived many lives and had many careers before finding my truest calling in data.
...
You could say that I am an artistic type. For most of my life, music has been the main avenue for my artistic self-expression. But I’ve also liked to take photos of street art in Helsinki, or when I’m travelling abroad.
...
More recently I authored my first R package, **col2hex2col** [@rask2026] with the help of **Claude Code**. The package provides simple functions to convert between color names and hexadecimal color codes using an extensive database of over 32,000 colors.

I also like to tinker with R Shiny. My app [TuneTeller](https://tuneteller.youcanbeapirate.com) received an *honorable mention* in the 2024 [Shiny Contest](https://posit.co/blog/winners-of-the-2024-shiny-contest/). I've since created others and you can find them all on my website [youcanbeapirate.com](https://youcanbeapirate.com/).
...
# For installing ggalt
pak("davidsjoberg/ggalt")

# For installing ggbump
pak("davidsjoberg/ggbump")

# For installing ggbraid
pak("nsgrantham/ggbraid")

# For installing ggTimeSeries
pak("AtherEnergy/ggTimeSeries")

# For fully updating radiant
options(repos = c(RSM = "https://radiant-rstats.github.io/minicran", CRAN = "https://cloud.r-project.org"))
pak("radiant-rstats/radiant.update", upgrade = FALSE)
```
...
- [ggplot2 extended (companion) by Antti Rask](https://companion.ggplot2-extended-book.com)
