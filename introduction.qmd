...
I've co-authored the __RandomWalker__ [@sanderson2024] R package with __Steven Paul Sanderson II__ ([\@spsanderson](https://github.com/spsanderson)). Specifically the function `visualize_walks()` that uses ggplot2 and some of the extensions found in this book.
