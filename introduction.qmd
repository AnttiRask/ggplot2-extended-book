...
I wanted to share the tools that make it easier to create those beautiful visualizations. And to show you how to use those tools together, not only with **ggplot2** [@wickham2024] but with each other.

One bit about terminology before we go any further. _Chart_, _diagram_, _graph_, _plot_, and _visualization_ are all terms that people have tried to give strict definitions to. But in reality, they get used more or less interchangeably. Is it a bar chart or a bar graph? Yes.

In the context of this book, I try to use the terms consistently in this way:

- __Chart / Diagram / Graph__: Type of visualization (e.g. bar chart, Venn diagram, or line graph)
- __Plot__: Output of some code to create a visualization. It can contain many charts, diagrams, and/or graphs. But sometimes it's also used to mean a type of visualization (e.g. scatter plot)
- __Visualization__: The most general of the terms. It can be used to talk about visualization as a concept. But sometimes it's also used for a more specific case.
